...
const Popover: FC<Props> = ({ className, absolute, id, value, onChange }) => {
  ...
  return (
    <span role="img" aria-label="star" className={classnames("comp-Star", className, { on: value, absolute })} onClick={onClick}>
