...
const Component: FC<LikesProps> = ({ likesNum = 0 }) => {
  return (
    <div className="comp-Likes">
      <svg viewBox="64 64 896 896" width="1em" height="1em" fill="currentColor" className="btn">
      ...
      <svg viewBox="64 64 896 896" width="1.08em" height="1.08em" fill="currentColor" className="btn">
